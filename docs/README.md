...
The version history itself lives in [`../CHANGELOG.md`](../CHANGELOG.md), which is also shipped
...
([architecture/overview.md](architecture/overview.md#where-the-codex-binary-comes-from)).
