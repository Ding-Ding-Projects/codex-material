...
[frontend-runtime.md](frontend-runtime.md#why-unsafe-eval-is-in-the-csp) for why `script-src`
carries `'unsafe-eval'`.
...
shapes and its security properties are in [ipc-bridge.md](ipc-bridge.md).
