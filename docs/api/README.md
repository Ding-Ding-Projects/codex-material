...
[../architecture/frontend-runtime.md](../architecture/frontend-runtime.md#why-unsafe-eval-is-in-the-csp).)
...
| Page | Why |
| --- | --- |
| [../architecture/ipc-bridge.md](../architecture/ipc-bridge.md) | The complete IPC command surface |
...
| [../build/packaging.md](../build/packaging.md) | What the installer actually contains |
